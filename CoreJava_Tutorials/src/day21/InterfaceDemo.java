...
public class InterfaceDemo implements Book {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//Book bk = new Book(); // not possible to create object for interface
	   ...
	   // bk.method3(); // not possible to call static method
	    ...
	    //bk.method4();//not possible to call the child class method with Interface reference 
	    
	    
	    InterfaceDemo obj1 = new InterfaceDemo();
	    obj1.method4("Sasidhar");
